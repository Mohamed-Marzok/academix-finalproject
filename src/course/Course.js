...
import { getQuestionBank } from "../redux/questionsBankSlice";
...
export default function Course() {
  ...
  const questionBank = useSelector((state) => state.questionBank.data);
  ...
  const renderList = useMemo(() => {
    switch (alignment) {
      ...
      case "play":
        return <YouTubePlaylist playlistId={playList} />;
      case "bank":
        return <QuestionBank questionBank={questionBank.flat()} />;
      case "code":
        return (
          <>
            <h2>
  ...
  }, [alignment, exams, assignments, lectures, posts, playList, id, role]);
  ...
  return (
    <Content>
      ...
      >
        ...
        <ToggleButton className="togBtn" value="bank" aria-label="bank">
          📰<p>Question Bank</p>
        </ToggleButton>
